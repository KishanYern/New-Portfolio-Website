        ...
        <div key={key}>
            <a href={github} target='_blank' rel='noreferrer'>
                <div
                    ...
                    hover:shadow-2xl duration-200 bg-gradient-to-br from-red-100 to-red-50 font-projects relative'
                >
                    <div className='text-4xl text-red-500 font-bold flex justify-center items-center mb-10 underline'>
                        {title}
                    </div>
                    <div className='text-black text-2xl px-4'>{info}</div>
                    <div className='flex flex-row gap-4 flex-wrap mt-10 justify-center items-center absolute bottom-10'>
                        {skills.map((skill) => {
