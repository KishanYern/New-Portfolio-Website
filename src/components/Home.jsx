    ...
    return (
        ...
        >
            ...
            <div className='z-10 mx-10 flex flex-col items-center justify-center h-full w-full px-4 md:flex-row'>
                <div className='text-9xl pr-56 ml-0 pl-0 font-bold bg-gradient-to-b from-red-700 to-red-400 bg-clip-text text-transparent'>
                    Kishan Yerneni
                </div>
                <div>
                    {' '}
